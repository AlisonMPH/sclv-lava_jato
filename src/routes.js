...
routes.get('/finalizacoes', FinalizacoesController.findAll);
routes.get('/finalizacoes/:id', FinalizacoesController.findByPk);
routes.post('/finalizacoes', FinalizacoesController.create);
